    ...
    {% load static %}
            <div class="col-12 font-weight-bolder" >
                <label style="margin-left: 30px; margin-top: 5px; font-size: 25px; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
                    <img src="{% static 'devices/img/direccion4.png' %}"> Histórico - General
                </label>       
            </div>     
    {% endblock %}
    {% block content %}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="horas">
                                ...
                                <div class="form-group col">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="custom-select" id="inputGroupSelect01" style="width: 280px;" name="sucur">
                            ...
                            <table class="table table-striped border border-info" style="text-align: center;">
                                <thead class="bg-info">
                                    <tr class="table-info">
                                        {% for per in per %}
                                            ...
                                            {% elif per == 'id' %}
                                            {% else%}
                                                <th style="padding-top: 0px;padding-bottom: 0px;" scope="col">{{ per }} </th>   
                                            {% endif %}
                                        {% endfor %}
                                    </tr>
                                </thead>
                                <tbody style="padding: 0px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.11}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.12}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.13}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.14}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.15}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.16}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.17}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.18}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.19}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.20}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.21}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.22}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.23}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.24}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.25}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.26}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.27}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.28}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.29}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.30}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.31}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.32}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.33}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.34}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.35}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.36}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.37}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.38}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.39}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.40}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.41}}</td>
                                        {% elif conteo == 13 %}
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.2}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.3}}</td>
                                        <td style="padding-top: 1px;padding-bottom: 1px;">{{users.4}}</td>
